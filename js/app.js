 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".reviews-contact__slider")) new core(".reviews-contact__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".reviews-contact-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".reviews-contact-button-prev",
                    nextEl: ".reviews-contact-button-next"
                },
                on: {}
            });
            if (document.querySelector(".examples-mob__slider")) new core(".examples-mob__slider", {
...
***************************************************************************** */
        ...
        if (items) {
            ...
            buttons.forEach((button => {
                if (".banner" === button.getAttribute("data-filter")) button.classList.add("active");
